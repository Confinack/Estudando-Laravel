...
Route::get('/registro-animal', [App\Http\Controllers\Adocao::class, 'registroAnimal'])->name("adocao");
...
Route::post('/animalCreate', [App\Http\Controllers\Animal::class, 'addAnimal'])->name("animalCreate");
